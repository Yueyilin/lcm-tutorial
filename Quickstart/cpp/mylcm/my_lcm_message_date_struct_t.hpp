...
#ifndef __mylcm_my_lcm_message_date_struct_t_hpp__
#define __mylcm_my_lcm_message_date_struct_t_hpp__
...
class my_lcm_message_date_struct_t
{
    public:
        int64_t    timestamp;
    ...
    public:
        ...
        /**
         * Returns "my_lcm_message_date_struct_t"
         */
...
int my_lcm_message_date_struct_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int my_lcm_message_date_struct_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int my_lcm_message_date_struct_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t my_lcm_message_date_struct_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* my_lcm_message_date_struct_t::getTypeName()
{
    return "my_lcm_message_date_struct_t";
}

int my_lcm_message_date_struct_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int my_lcm_message_date_struct_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int my_lcm_message_date_struct_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t my_lcm_message_date_struct_t::_computeHash(const __lcm_hash_ptr *)
{
